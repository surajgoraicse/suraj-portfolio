...
export const DATA = {
	...
	education: [
		{
			school: "Netaji Subhas University",
			href: "https://nsuniv.ac.in/",
			degree: "B-Tech CSE",
			logoUrl: "/nsu-logo.png",
			start: "2024",
			end: "2028",
		},
		{
			school: "Jamshedpur Co-operative College",
			href: "https://interjcc.in/",
			degree: "Intermediate of Science",
			logoUrl: "/jcc-logo.png",
			start: "2022",
			end: "2024",
		},
	],
	...
	projects: [
		{
			...
			active: true,
			description:
				"This portfolio is a modern, high-performance web application built with Next.js, leveraging **server-side rendering** and **static site generation** for optimal speed and SEO.",
			technologies: [
				"Next.js",
				"Typescript",
				"TailwindCSS",
